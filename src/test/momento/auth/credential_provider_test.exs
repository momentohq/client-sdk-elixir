alias Momento.Auth.CredentialProvider, as: CredentialProvider

defmodule CredentialProviderTest do
  use ExUnit.Case
  doctest Momento.Auth.CredentialProvider

  @test_control_endpoint "control-plane-endpoint.not.a.domain"
  @test_cache_endpoint "cache-endpoint.not.a.domain"

  # const testControlEndpoint = '';
  ...
  @fake_test_legacy_token "eyJhbGciOiJIUzUxMiJ9.eyJzdWIiOiJmb29Abm90LmEuZG9tYWluIiwiY3AiOiJjb250cm9sLXBsYW5lLWVuZHBvaW50Lm5vdC5hLmRvbWFpbiIsImMiOiJjYWNoZS1lbmRwb2ludC5ub3QuYS5kb21haW4ifQo.rtxfu4miBHQ1uptWJ2x3UiAwwJYcMeYIkkpXxUno_wIavg4h6YJStcbxk32NDBbmJkJS7mUw6MsvJNWaxfdPOw"

  describe "StringMomentoTokenProvider" do
    test "should parse a valid legacy token" do
      provider = CredentialProvider.from_string!(@fake_test_legacy_token)

      assert provider.auth_token == @fake_test_legacy_token
